...
;****************************************
gr_init_hires:
	stx gr_pixcol		; Save pixel colour
	...
	sta gr_screen_h
	lda #7
	sta gr_cur_off		; Cursor on bottom row
	...
	lda vdp_addr_col+1
	jsr _vdp_wr_addr
	; set colour for $18 pages (6144) bytes
	lda gr_pixcol		; Get the colour value
...
gr_hchar_getlimage:
	...
	phx
	ldy gr_pixmode		; Get the mode to plot 0,1,2 (erase, draw, xor)
...
gr_box_plot:
	...
	sta tmp_chi
	ldx gr_pixmode	; Use screen mode
...
gr_line_skip_xy_swap:
	...
	lda #$ff					; make x increment negative
	sta grl_inx
...
gr_line_skip_x_swap:
	...
	lda #$ff					; make y increment negative
	sta grl_iny
